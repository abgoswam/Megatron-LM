...
JOB_PATH="/mnt/synthdatastore/agoswami/test001"
DATA_PATH="${JOB_PATH}/agoswami_gpt2_red_pajama_text_document"
VOCAB_FILE="${JOB_PATH}/gpt2-vocab.json"
MERGE_FILE="${JOB_PATH}/gpt2-merges.txt"
